...
public sealed class PackageIntegrationTest : EditorConfigFixture
{
	...
	public async Task LoadsRulesAndOverridesAcrossTargetFrameworks()
	{
		...
		foreach(var framework in new[] { "net8.0", "net9.0", "net10.0" })
		{
			...
			foreach(var id in new[] { "ZS0005", "ZS2003", "IDE0055", "ZS1301", "ZS1302", "ZS1304" })
		...
		foreach(var id in new[] { "ZS0005", "ZS2003", "IDE0055", "ZS1301", "ZS1302", "ZS1304", "AD0001", "CS8032", "CS9057", "MultipleGlobalAnalyzerKeys" })
